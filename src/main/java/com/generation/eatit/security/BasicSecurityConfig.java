package com.generation.eatit.security;
...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/temas").permitAll().antMatchers(HttpMethod.GET, "/postagens").permitAll()
				.antMatchers(HttpMethod.GET, "/usuarios/*").permitAll()
				.antMatchers(HttpMethod.PUT, "/usuarios/atualiza").permitAll().antMatchers(HttpMethod.OPTIONS)
